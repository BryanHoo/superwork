 ...
 * - src/templates/superwork/ - Workflow scripts and config
 ...
 *
 * Note: We NO LONGER copy from the project's own .superwork/, .cursor/, .claude/
 * because those may be customized for the Superwork project itself.
 */
