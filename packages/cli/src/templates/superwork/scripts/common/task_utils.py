...
def resolve_task_dir(target_dir: str, repo_root: Path) -> Path:
    ...
    - Relative path: .superwork/tasks/01-31-my-task
    ...
    # Relative path (contains path separator or starts with .superwork)
    if "/" in normalized or normalized.startswith(".superwork"):
...
if __name__ == "__main__":
    ...
    print(f"is_safe_task_path('.superwork/tasks/test'): {is_safe_task_path('.superwork/tasks/test', repo)}")
