...
#
# Usage:
#   ./.superwork/scripts/task.sh create "<title>" [--slug <name>] [--assignee <dev>] [--priority P0|P1|P2|P3]
#   ./.superwork/scripts/task.sh init-context <dir> <type>   # Initialize jsonl files
#   ./.superwork/scripts/task.sh add-context <dir> <file> <path> [reason] # Add jsonl entry
#   ./.superwork/scripts/task.sh validate <dir>              # Validate jsonl files
#   ./.superwork/scripts/task.sh list-context <dir>          # List jsonl entries
#   ./.superwork/scripts/task.sh start <dir>                 # Set as current task
#   ./.superwork/scripts/task.sh finish                      # Clear current task
#   ./.superwork/scripts/task.sh set-branch <dir> <branch>   # Set git branch
#   ./.superwork/scripts/task.sh set-scope <dir> <scope>     # Set scope for PR title
#   ./.superwork/scripts/task.sh create-pr [dir] [--dry-run] # Create PR from task
#   ./.superwork/scripts/task.sh archive <task-name>         # Archive completed task
#   ./.superwork/scripts/task.sh list                        # List active tasks
#   ./.superwork/scripts/task.sh list-archive [month]        # List archived tasks
#
...
cmd_set_branch() {
  ...
  echo "  ./.superwork/scripts/multi-agent/start.sh $1"
}
