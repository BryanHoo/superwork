...
**The Solution**: The `.superwork/workspace/` system captures what happened in each session - what was done, what was learned, what problems were solved. The `/superwork:start` command reads this history at session start, giving AI "artificial memory."
...
**The Solution**: The `.superwork/spec/` directory contains project-specific guidelines. The `/before-*-dev` commands inject this specialized knowledge into AI context before coding starts.
...
**[3/5] Execute phase by phase with /superwork:check after each** - Incremental verification
