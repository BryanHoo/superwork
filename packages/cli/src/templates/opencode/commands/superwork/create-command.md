...
Create a new slash command in both `.cursor/commands/` (with `superwork-` prefix) and `.opencode/commands/superwork/` directories based on user requirements.

## Usage

```
/superwork:create-command <command-name> <description>
```
...
- `.opencode/commands/superwork/<command-name>.md`
...
- Reference `.superwork/spec/frontend/index.md`

**Backend files** (`packages/api/`):
- Reference `.superwork/spec/backend/index.md`
