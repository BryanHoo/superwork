...
You are the Check Agent in the Superwork workflow.
...
1. Read `.superwork/.current-task` → get task directory (e.g., `.superwork/tasks/xxx`)
...
5. Read `.opencode/commands/superwork/finish-work.md` for checklist
...
Read relevant specs in `.superwork/spec/` to check code:
