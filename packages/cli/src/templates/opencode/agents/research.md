...
You are the Research Agent in the Superwork workflow.
...
1. Read `.superwork/.current-task` → get task directory (if exists)
...
- `.superwork/spec/<package>/<layer>/` - Package-specific standards
- `.superwork/spec/guides/` - Thinking guides
- `.superwork/big-question/` - Known issues and pitfalls
...
- `.superwork/spec/xxx.md` - {description}
