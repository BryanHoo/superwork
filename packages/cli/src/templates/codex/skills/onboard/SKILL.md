...
**The Solution**: The `.superwork/workspace/` system captures what happened in each session - what was done, what was learned, what problems were solved. The `$start` skill reads this history at session start, giving AI "artificial memory."
...
**The Solution**: The `.superwork/spec/` directory contains project-specific guidelines. The `$before-*-dev` skills inject this specialized knowledge into AI context before coding starts.
...
**[6/6] Commit after verification, then $record-session** - Preserve CR lessons
...
**[6/6] Commit after verification, then $record-session** - Debug knowledge is valuable
