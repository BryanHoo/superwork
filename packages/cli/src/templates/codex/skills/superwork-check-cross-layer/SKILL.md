---
name: superwork-check-cross-layer
...
> **Note**: This is a **post-implementation** safety net. Ideally, read the [Pre-Implementation Checklist](.superwork/spec/guides/pre-implementation-checklist.md) **before** writing code.
...
|----------|---------|--------|
| [Pre-Implementation Checklist](.superwork/spec/guides/pre-implementation-checklist.md) | Questions before coding | **Before** writing code |
| [Code Reuse Thinking Guide](.superwork/spec/guides/code-reuse-thinking-guide.md) | Pattern recognition | During implementation |
| **`$superwork-check-cross-layer`** (this skill) | Verification check | **After** implementation |
...
**Detailed Guide**: `.superwork/spec/guides/cross-layer-thinking-guide.md`
...
**Detailed Guide**: `.superwork/spec/guides/code-reuse-thinking-guide.md`
