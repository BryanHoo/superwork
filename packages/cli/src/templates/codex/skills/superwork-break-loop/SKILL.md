...
- [ ] Update `.superwork/spec/guides/` thinking guides
- [ ] Update `.superwork/spec/backend/` or `frontend/` docs
...
2. **Sync templates** - After updating `.superwork/spec/`, sync to `src/templates/markdown/spec/`
