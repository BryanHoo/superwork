...
description: "Initializes an AI development session by reading workflow guides, developer identity, git status, active tasks, and project guidelines from .superwork/. Classifies incoming tasks and routes to superwork-brainstorm, superwork-spec-plan, superwork-execute-plan, direct edit, or superwork-debug-root-cause. Use when beginning a new coding session, resuming work, starting a new task, or re-establishing project context."
---
...
> See the `superwork-brainstorm` skill's Step 8 for details.
...
See `$superwork-brainstorm` for the full process. Summary:
...
- Use `$superwork-check`
- Use `$superwork-check-cross-layer` if the task changes contracts or spans layers
...
| Skill | When to Use |
|---------|-------------|
| `$superwork-start` | Begin a session (this skill) |
...
| `python3 ./.superwork/scripts/task.py create` | Create task directory |
| `python3 ./.superwork/scripts/task.py init-context` | Initialize jsonl files |
| `python3 ./.superwork/scripts/task.py add-context` | Add spec to jsonl |
| `python3 ./.superwork/scripts/task.py start` | Set current task |
| `python3 ./.superwork/scripts/task.py finish` | Clear current task |
| `python3 ./.superwork/scripts/task.py archive` | Archive completed task |
