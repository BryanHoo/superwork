...
Create a new slash command in both `.codebuddy/commands/superwork/` and `.claude/commands/superwork/` directories based on user requirements.
...
- `.codebuddy/commands/superwork/<command-name>.md`
