...
Superwork auto-detects your platform based on config directories. For Cursor users, ensure detection works correctly:
...
```bash
export SUPERWORK_PLATFORM=cursor
```

Or prefix commands:

```bash
SUPERWORK_PLATFORM=cursor python3 ./.superwork/scripts/task.py list
```
