...
describe("detectProjectType", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "superwork-detect-"));
  });
...
describe("detectMonorepo", () => {
  ...
  beforeEach(() => {
    tmpDir = fs.mkdtempSync(path.join(os.tmpdir(), "superwork-monorepo-"));
  });
  ...
  it("merges pnpm workspace + .gitmodules and marks submodule", () => {
    ...
    mkPkg("packages/cli", "@superwork/cli");
    mkPkg("docs-site", "docs-site");
