...
describe("DIR_NAMES", () => {
  ...
  it("WORKFLOW is .superwork", () => {
    expect(DIR_NAMES.WORKFLOW).toBe(".superwork");
  });
...
describe("getWorkspaceDir", () => {
  it("returns correct path for developer name", () => {
    expect(getWorkspaceDir("john")).toBe(".superwork/workspace/john");
  });

  it("handles hyphenated names", () => {
    expect(getWorkspaceDir("john-doe")).toBe(".superwork/workspace/john-doe");
  });

  it("handles empty string", () => {
    expect(getWorkspaceDir("")).toBe(".superwork/workspace/");
  });
});
...
describe("getTaskDir", () => {
  it("returns correct path for task name", () => {
    expect(getTaskDir("01-21-my-task")).toBe(".superwork/tasks/01-21-my-task");
  });

  it("handles nested-looking names", () => {
    expect(getTaskDir("sub/task")).toBe(".superwork/tasks/sub/task");
  });

  it("handles empty string", () => {
    expect(getTaskDir("")).toBe(".superwork/tasks/");
  });
});
...
describe("getArchiveDir", () => {
  it("returns correct archive path", () => {
    expect(getArchiveDir()).toBe(".superwork/tasks/archive");
  });
