...
describe("template path functions", () => {
  it("getSuperworkTemplatePath returns existing directory", () => {
    const p = getSuperworkTemplatePath();
...
// =============================================================================
// readSuperworkFile — reads files from superwork template directory
// =============================================================================
...
// =============================================================================
// readScript — helper wrapping readSuperworkFile
// =============================================================================
...
// =============================================================================
// readMarkdown — helper wrapping readSuperworkFile
// =============================================================================
...
describe("readGeminiFile", () => {
  it("reads a toml file from gemini templates", () => {
    const content = readGeminiFile("commands/superwork/start.toml");
    expect(typeof content).toBe("string");
    expect(content.length).toBeGreaterThan(0);
